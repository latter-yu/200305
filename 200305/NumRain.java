...
class RainbowRain extends Canvas implements Runnable {
	...
	public RainbowRain(int width, int height) {
		this.width = width;
		this.height = height;
...
public class NumRain extends JFrame {
	...
	private RainbowRain canvas = new RainbowRain(screenSize.width, screenSize.height);
